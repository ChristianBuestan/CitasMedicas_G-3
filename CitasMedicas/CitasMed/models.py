...
class MedicoPersonal(models.Model):
    ...
    reportes = models.ForeignKey(Reporte, on_delete=models.CASCADE)

class Paciente(models.Model):
    pac_nombre_completo = models.CharField(max_length=255)
    pac_fecha_nacimiento = models.DateField(default=timezone.now)
...
class PlanCuentas(models.Model):
    plan_cue_fecha_transaccion = models.DateField(default=timezone.now)
